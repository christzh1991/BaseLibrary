 ...
 * @date  2020年12月3日
 */
class UserProfile constructor(context: Context?) {
     ...
     * @param account
     */
    fun setUserAccount(account: Object?) {
        if (account != null) {
    ...
    fun getShowPreferencesTimes(): Int {
        mShowPreferencesTimes = mPreferences.getInt(getAccountId() + SHOW_PREFERENCES_TIMES, 0)
    ...
    fun setShowPreferencesTimes(showPreferencesTimes: Int) {
        if (mContext != null) {
            ...
            mPreferences.edit()
                .putInt(getAccountId() + SHOW_PREFERENCES_TIMES, mShowPreferencesTimes).apply()
        }
    }
    ...
    fun getDurationOfUseThisWeek(): Int {
        val durationOfUseThisWeek: Int =
            mPreferences.getInt(getAccountId() + DURATION_OF_USE_THIS_WEEK, 0)
    ...
    fun setDurationOfUseThisWeek(durationofusethisweek: Int) {
        if (mContext != null) {
            mPreferences.edit()
                .putInt(getAccountId() + DURATION_OF_USE_THIS_WEEK, durationofusethisweek).apply()
        }
    }
